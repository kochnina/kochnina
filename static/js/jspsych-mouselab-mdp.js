...
jsPsych.plugins['mouselab-mdp'] = (function() {
  ...
  MouselabMDP = (function() {
    ...
    MouselabMDP.prototype.showScore = function(v) {
      return $('#mouselab-score').css('visibility', 'visible'); // Score
    };
